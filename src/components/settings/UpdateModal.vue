	...
	methods: {
		...
		getUpdateLogs() {
			this.updateTimer = setInterval(() => {
				this.$api.file.getContent(`/var/log/cassetteos/upgrade.log`).then(res => {

					this.updateLogs = res.data.data;
					if (this.updateLogs.includes(`CassetteOS upgrade successfully`)) {
					...
					} else if (this.updateLogs.includes(`CassetteOS upgrade failed`)) {
